...
export declare class TaskClient extends ResourceClient {
     ...
     * https://docs.apify.com/api/v2#/reference/actor-tasks/run-collection/run-task
     */
    call(input?: Dictionary, options?: TaskStartOptions): Promise<ActorRun>;
    /**
...
export declare type TaskUpdateData = Partial<Pick<Task, 'name' | 'description' | 'options' | 'input'>>;
export interface TaskLastRunOptions {
    status?: keyof typeof ACT_JOB_STATUSES;
}
export declare type TaskStartOptions = Omit<ActorStartOptions, 'contentType'>;
