...
const async_retry_1 = (0, tslib_1.__importDefault)(require("async-retry"));
const agentkeepalive_1 = (0, tslib_1.__importDefault)(require("agentkeepalive"));
const os_1 = (0, tslib_1.__importDefault)(require("os"));
const consts_1 = require("@apify/consts");
const apify_api_error_1 = require("./apify_api_error");
const interceptors_1 = require("./interceptors");
const utils_1 = require("./utils");
const { version } = (0, utils_1.dynamicRequire)('../package.json');
...
class HttpClient {
    constructor(options) {
        ...
        this.workflowKey = options.workflowKey || process.env[consts_1.ENV_VARS.WORKFLOW_KEY];
        ...
        if ((0, utils_1.isNode)()) {
            ...
            const userAgent = `ApifyClient/${version} (${os_1.default.type()}; Node/${process.version}); isAtHome/${!!process.env.IS_AT_HOME}`;
