...
const fix_decompress_1 = require("./hooks/fix-decompress");
const gotScraping = got_cjs_1.got.extend({
    handlers: [
        fix_decompress_1.fixDecompress,
    ],
...
const setupDecodeURI = () => {
    const { set } = Object.getOwnPropertyDescriptor(got_cjs_1.Options.prototype, 'url');
    Object.defineProperty(got_cjs_1.Options.prototype, 'url', {
        set(value) {
