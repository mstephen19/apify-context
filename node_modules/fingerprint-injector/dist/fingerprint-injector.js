...
const useragent = (0, tslib_1.__importStar)(require("useragent"));
...
class FingerprintInjector {
    constructor() {
        Object.defineProperty(this, "log", {
            ...
            configurable: true,
            writable: true,
            value: log_1.default.child({ prefix: 'FingerprintInjector' })
        });
     ...
     */
    async attachFingerprintToPlaywright(browserContext, fingerprint) {
     ...
     * @param fingerprint - fingerprint from [`fingerprint-generator`](https://github.com/apify/fingerprint-generator)
     */
    async attachFingerprintToPuppeteer(page, fingerprint) {
        const enhancedFingerprint = this._enhanceFingerprint(fingerprint);
     ...
     */
    _getInjectableFingerprintFunction(fingerprint) {
        function inject() {
    ...
    _enhanceFingerprint(fingerprint) {
        const { battery, navigator, userAgent, ...rest } = fingerprint;
