...
async function enqueueLinksByClickingElements(options) {
    ...
    const { page, requestQueue, selector, pseudoUrls, transformRequestFunction, waitForPageIdleSecs = 1, maxWaitForPageIdleSecs = 5, } = options;
...
async function clickElementsAndInterceptNavigationRequests(options) {
    const { page, selector, waitForPageIdleMillis, maxWaitForPageIdleMillis, } = options;
