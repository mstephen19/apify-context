...
exports.isUrlRelative = exports.splitFullName = exports.jsonStringifyExtended = exports.JsonVariable = exports.isBadForMongo = exports.unescapeFromBson = exports.escapeForBson = exports.traverseObject = exports.unescapePropertyName = exports.escapePropertyName = exports.buildOrVersionNumberIntToStr = exports.markedDecreaseHeadsLevel = exports.markedSetNofollowLinks = exports.normalizeUrl = exports.parseUrl = exports.getOrdinalSuffix = exports.truncate = exports.dateToString = exports.isBuffer = exports.isNullOrUndefined = void 0;
...
function buildOrVersionNumberIntToStr(int) {
    if (typeof int !== 'number' || !(int >= 0))
        return null;
    const major = Math.floor(int / consts_1.VERSION_INT_MAJOR_BASE);
    const remainder = int % consts_1.VERSION_INT_MAJOR_BASE;
    const minor = Math.floor(remainder / consts_1.VERSION_INT_MINOR_BASE);
    const build = remainder % consts_1.VERSION_INT_MINOR_BASE;
    let str = `${major}.${minor}`;
    if (build > 0)
        str += `.${build}`;
    return str;
...
exports.escapeForBson = escapeForBson;
/**
...
exports.unescapeFromBson = unescapeFromBson;
/**
...
exports.isBadForMongo = isBadForMongo;
class JsonVariable {
    constructor(name) {
        this.name = name;
    }
...
exports.JsonVariable = JsonVariable;
/**
...
exports.jsonStringifyExtended = jsonStringifyExtended;
/**
...
function isUrlRelative(url) {
    return consts_1.RELATIVE_URL_REGEX.test(url);
}
