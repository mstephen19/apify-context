...
exports.HealthChecker = exports.CHECK_TYPES = void 0;
const utilities_1 = require("./utilities");
var CHECK_TYPES;
(function (CHECK_TYPES) {
    CHECK_TYPES["MONGODB_READ"] = "MONGODB_READ";
    CHECK_TYPES["MONGODB_WRITE"] = "MONGODB_WRITE";
    CHECK_TYPES["REDIS"] = "REDIS";
})(CHECK_TYPES = exports.CHECK_TYPES || (exports.CHECK_TYPES = {}));
/**
...
class HealthChecker {
    constructor(options) {
        ...
        const { checks, redisPrefix = 'health-check', redisTtlSecs = 15, checkTimeoutMillis = 15000, mongoDbWriteTestCollection = 'healthCheckPlayground', mongoDbWriteTestRemoveOlderThanSecs = 15, } = options;
