...
exports.WebhookPayloadTemplate = exports.InvalidVariableError = exports.InvalidJsonError = void 0;
const utilities_client_1 = require("./utilities.client");
...
class InvalidJsonError extends WebhookPayloadTemplateError {
...
class WebhookPayloadTemplate {
    ...
    static getVariable(variableName) {
        return new utilities_client_1.JsonVariable(variableName);
    }
    _parse() {
        while (true) {
...
exports.WebhookPayloadTemplate = WebhookPayloadTemplate;
